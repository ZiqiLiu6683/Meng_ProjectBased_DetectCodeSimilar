...
//   5. API Call Vocabulary   – file-level external API call set Jaccard (CLAN-inspired)
...
public class AstMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // ================================================================
        // Strategy 5 – API Call Vocabulary Jaccard (file level, CLAN-inspired)
        // ================================================================
        ...
        // --- Strategy 5 ---
        System.out.println("-- Strategy 5: API Call Vocabulary Jaccard (file level, CLAN-inspired) --");
        System.out.printf("  API calls   : A=%d unique, B=%d unique%n",
                apiCallsA.size(), apiCallsB.size());
        // Intersection for display
        Set<String> apiIntersect = new java.util.HashSet<>(apiCallsA);
        apiIntersect.retainAll(apiCallsB);
        System.out.printf("  Intersection: %d  (shared external API names)%n", apiIntersect.size());
